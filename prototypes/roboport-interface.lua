...
-- Main recipe.
local ingredients = {{'constant-combinator', 1}, {'radar', 1}, {'roboport', 1}}
...
Data{
    type = 'item',
    name = 'roboport-interface',
    icons = {{icon = '__RoboportInterface__/graphics/icons/roboport-interface.png', icon_size = 32}},
    icon_size = 32,
    icon_mipmaps = 1,
...
Data{
    ...
    icons = {{icon = '__RoboportInterface__/graphics/icons/roboport-interface-cc.png', icon_size = 32}},
    icon_size = 32,
    icon_mipmaps = 1,
    flags = {'hidden'},
    subgroup = 'logistic-network',
...
ri_cc.icon = nil
ri_cc.icons = {{icon = '__RoboportInterface__/graphics/icons/roboport-interface-cc.png'}}
ri_cc.icon_size = 32
...
ri_radar.energy_usage = '1MW' --'300kW'
